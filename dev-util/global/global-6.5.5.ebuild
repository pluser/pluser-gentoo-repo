...
IUSE="doc emacs vim pygments ctags sqlite"
...
src_configure() {
	econf \
		...
		$(use_with ctags universal-ctags)\
...
pkg_postinst() {
	...
	use pygments && einfo "You will need '--gtagslabel=pygments' option when you execute gtags to cooporate with pygments."
}
